...
4. **VL3D Streaming Client and Server:**
...
5. **On-Prem Model Converter:**
    ...
    - **Implementation:** I designed a lean microservice in Ruby using Sinatra, which simplified the conversion process and significantly reduced processing times by 67%. Containerizing this service with Docker and deploying it on a Kubernetes cluster further reduced server costs by 30%.
